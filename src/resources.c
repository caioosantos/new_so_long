...
/*   Updated: 2025/03/17 13:52:15 by cbrito-s         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static void	load_images(t_game *game)
{
	...
	game->texture.floor = mlx_texture_to_image(game->mlx, \
		game->texture.t_floor);
	game->texture.exit = mlx_texture_to_image(game->mlx, \
		game->texture.t_exit);
	game->texture.collectible = mlx_texture_to_image(game->mlx, \
		game->texture.t_collectible);
	game->texture.player = mlx_texture_to_image(game->mlx, \
		game->texture.t_player);
...
static void	load_textures(t_game *game)
{
	...
	if (!game->texture.t_wall || !game->texture.t_floor
		|| !game->texture.t_exit || !game->texture.t_collectible
		|| !game->texture.t_player)
